# -*- coding: utf-8 -*-
#
# dockpanelsuite documentation build configuration file, created by
...
project = u'dockpanelsuite'
copyright = u'2015-2017, Ryan Rastedt, Lex Li, and others'
author = u'Ryan Rastedt, Lex Li, and others'
...
html_context = {
    'on_rtd' : on_rtd,
    'display_github': True,
    'github_user': 'dockpanelsuite',
    'github_repo': 'dockpanelsuite_docs',
...
htmlhelp_basename = 'dockpanelsuitedoc'
...
def setup(app):
    ...
    if not on_rtd:
        ...
        """
        app.add_js_file("https://www.googletagmanager.com/gtag/js?id=UA-1962620-10")
